...
function AuthContent() {
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-background">
        <div className="bg-card w-full max-w-sm rounded-3xl p-8 border border-border text-center shadow-lg">
          ...
          <h1 className="text-xl font-bold mb-2">No pudimos validar tu acceso</h1>
          <p className="text-muted-foreground text-sm mb-6">
            {error || "Tu enlace ya no es válido. Pídele uno nuevo al asistente de WhatsApp."}
          </p>
          <button 
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background">
      ...
      <p className="font-medium text-foreground">Entrando a tu portal...</p>
    </div>
  );
}
