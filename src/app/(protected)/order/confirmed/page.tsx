...
function ConfirmationContent() {
  ...
  const handleContactExecutive = async () => {
     ...
     try {
         ...
         window.open(`https://wa.me/5218110000000?text=Hola%20soy%20${data.name}%20(B2B).%20Quisiera%20saber%20sobre%20mi%20pedido%20${orderName}`, '_blank');
     } catch (e) {
         window.open(`https://wa.me/5218110000000?text=Hola.%20Quisiera%20saber%20sobre%20mi%20pedido%20${orderName}`, '_blank');
     }
  };
